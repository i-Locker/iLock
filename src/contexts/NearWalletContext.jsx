...
WalletConnection.prototype.requestSignIn = async function requestSignIn({ contractId, methodNames, successUrl, failureUrl, }) {
...
export const NearContextProvider = ({ children, }) => {
    ...
    const disconnect = useCallback(() => {
        ...
        selector
            ?.wallet()
            .then((wallet) => wallet.signOut().catch((error) => console.error(error)));
    }, [selector, modal]);
    const value = useMemo(() => ({
        connect,
        disconnect,
