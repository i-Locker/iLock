import { Dialog, DialogTitle, IconButton, List, ListItem, ListItemIcon, ListItemText, makeStyles, } from "@material-ui/core";
...
const WalletOptions = ({ connection, connect, onClose, }) => {
...
const EvmConnectWalletDialog = ({ isOpen, onClose, chainId, }) => {
    ...
    const availableWallets = availableConnections
        ...
        .map((connection) => (<WalletOptions connection={connection} connect={connect} onClose={onClose} key={connection.name}/>));
