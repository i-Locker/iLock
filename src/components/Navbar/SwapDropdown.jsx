...
import { Menu, MenuButton, MenuItem, MenuList, Button, Text, Flex, Box, Img, Divider, useColorModeValue, Tooltip, } from "@chakra-ui/react";
...
const Nav = ({ to, label, children, img }) => (<NavLink to={to} activeStyle={{
    color: "#319EF6",
}}>
...
export function SwapDropdown() {
    ...
    return (<Menu>
      <MenuButton variant="ghost" as={Button} transition="all 0.2s" rightIcon={<ChevronDownIcon />} fontWeight={200} _focus={{ color: "#319EF6" }} fontSize="14px" padding="5px 6px" textTransform={'capitalize'}>
        {useName()}
      </MenuButton>
      <MenuList>
...
export function BridgeDropdown() {
    ...
    <MenuList width="408px" height="289px" boxShadow="0px 4px 20px -4px rgba(0, 0, 0, 0.1)" borderRadius="6px" boxSizing="border-box" padding="16px 16px 24px 16px" background={background}>
      ...
      <MenuItem cursor="pointer" _focus={{ color: "#319EF6" }} py="10px" _hover={{ background: `${bg}`, boxShadow: `${boxShadow}`, borderRadius: "6px" }} mt="3px">
        <Nav to="#">
        ...
        <Box ml="20px">
        <Text fontWeight="700" fontSize="16px" color="#319EF6">Bridge RGPs on Spherium</Text>
      <Text fontWeight="400" fontSize="14px" color="#51627B" mt="3px">Bridge via hyperbridge.</Text>
        </Box>
            </Flex>
          <Box>
      ...
      <MenuItem _focus={{ color: "#319EF6" }} mt="20px" py="10px" _hover={{ background: `${bg}`, boxShadow: `${boxShadow}`, borderRadius: "6px" }}>
  ...
  <Flex>
        ...
        <Box ml="20px">
        <Text fontWeight="700" fontSize="16px" color="#319EF6">Bridge RGPs on Router</Text>
      <Text fontWeight="400" fontSize="14px" color="#51627B" mt="3px">Bridge via Router Voyager</Text>
        </Box>
          </Flex>
          <Box>
          <ArrowForwardIcon fontSize="24px" mt="15px" color="white"/>
