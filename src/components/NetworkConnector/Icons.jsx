...
export function EthereumIcon() {
    return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12.3735 15.4297L17.9963 12.165L12.3735 9.65399V15.4297Z" fill="white" fill-opacity="0.2"/>
      <path d="M6.75 12.165L12.3735 15.4297V9.65399L6.75 12.165Z" fill="white" fill-opacity="0.602"/>
    </svg>);
}
export function PolygonIcon() {
    return (<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="32.000000pt" height="32.000000pt" viewBox="0 0 32.000000 32.000000" preserveAspectRatio="xMidYMid meet">
    <metadata>
