import { Button, Modal, Box, Text, Flex, ModalCloseButton, ModalContent, ModalOverlay, useDisclosure, Img, } from "@chakra-ui/react";
...
function NetworkIndicator() {
    ...
    const handleUpdateChainId = useCallback((value) => {
    ...
    const info = chainId ? CHAIN_INFO[chainId] : CHAIN_INFO[ChainId];
    ...
    const changeNetwork = async (network, id) => {
        onClose();
        switchNetwork(network, account, library).then(() => {
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="sm">
        ...
        <ModalContent>
          <Flex flexDirection="column" mx={5}>
            <Flex my={4}>
              <ModalCloseButton border={mode === "dark" ? "1px solid #FFF" : "1px solid #666666"}/>
            </Flex>
            <Flex mt={8}>
              <Text fontSize="20px" lineHeight="28px" color={mode === "dark" ? "#F1F5F8" : "#333333"}>
                Change Network
              </Text>
            </Flex>
            <Flex>
              <Text fontSize="16px" lineHeight="28px" color={mode === "dark" ? "#F1F5F8" : "#333333"} mb={3}>
            ...
            <Flex backgroundColor={mode === "dark" ? "#15202B" : "#FFFFFF"} border={mode === "dark" ? "1px solid #324D68" : "1px solid #DEE6ED"} borderRadius="6px" py={4} px={3} mb={3} cursor="pointer" textAlign={"left"} onClick={() => {
        changeNetwork("0x3", 3);
    }}>
              <Flex>
                <Box px={2}>
            ...
            <Flex backgroundColor={mode === "dark" ? "#15202B" : "#FFFFFF"} border={mode === "dark" ? "1px solid #324D68" : "1px solid #DEE6ED"} borderRadius="6px" py={4} px={3} mb={3} cursor="pointer" onClick={() => {
        changeNetwork("0x38", 56);
            ...
            <Flex backgroundColor={mode === "dark" ? "#15202B" : "#FFFFFF"} border={mode === "dark" ? "1px solid #324D68" : "1px solid #DEE6ED"} borderRadius="6px" px={3} py={4} mb={4} cursor="pointer" onClick={() => {
        changeNetwork("0x89", 137);
            ...
            <Flex backgroundColor={mode === "dark" ? "#15202B" : "#FFFFFF"} border={mode === "dark" ? "1px solid #324D68" : "1px solid #DEE6ED"} borderRadius="6px" px={3} py={4} mb={4} cursor="pointer" onClick={() => changeNetwork("0xa516", 42262)}>
              <Flex>
                <Box px={2}>
            ...
            <Flex backgroundColor={mode === "dark" ? "#15202B" : "#FFFFFF"} border={mode === "dark" ? "1px solid #324D68" : "1px solid #DEE6ED"} borderRadius="6px" px={3} py={4} mb={4} cursor="pointer" onClick={() => changeNetwork("0xA86A", 43114)}>
              <Flex>
                <Box px={2}>
