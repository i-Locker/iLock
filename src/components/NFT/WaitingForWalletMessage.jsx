...
import { selectNFTIsRedeeming, selectNFTIsSending, selectNFTRedeemTx, selectNFTSourceChain, selectNFTTargetChain, selectNFTTransferTx, } from "../../store/selectors";
...
export default function WaitingForWalletMessage() {
    ...
    return showWarning ? (<Typography className={classes.message} variant="body2">
