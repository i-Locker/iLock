...
import { selectNFTSourceWalletAddress, selectNFTSourceChain, selectNFTTargetError, selectNFTTransferTx, selectNFTIsSendComplete, } from "../../store/selectors";
...
function Send() {
    ...
    const isWrongWallet = sourceWalletAddress &&
        walletAddress &&
    ...
    return (<>
      ...
      {isTerraChain(sourceChain) && (<TerraFeeDenomPicker disabled={disabled} chainId={sourceChain}/>)}
      ...
      <ButtonWithLoader disabled={isDisabled} onClick={handleClick} showLoader={showLoader} error={errorMessage}>
        Transfer
      </ButtonWithLoader>
