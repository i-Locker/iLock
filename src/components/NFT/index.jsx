...
import { selectNFTActiveStep, selectNFTIsRedeemComplete, selectNFTIsRedeeming, selectNFTIsSendComplete, selectNFTIsSending, } from "../../store/selectors";
...
function NFT() {
    ...
    useEffect(() => {
        ...
        try {
            const sourceChain = CHAINS_WITH_NFT_SUPPORT.find((x) => parseFloat(pathSourceChain || "") === x.id)?.id;
            const targetChain = CHAINS_WITH_NFT_SUPPORT.find((x) => parseFloat(pathTargetChain || "") === x.id)?.id;
    ...
    return (<Container maxWidth="md">
      <Stepper activeStep={activeStep} orientation="vertical">
        ...
        <Step expanded={activeStep >= 1} disabled={preventNavigation || isRedeemComplete || activeStep === 0}>
