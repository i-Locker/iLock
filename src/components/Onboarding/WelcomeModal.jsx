...
import { ModalOverlay, ModalContent, Modal, useColorModeValue, Box, Flex, Text, Button, Image, } from "@chakra-ui/react";
    ...
    return (<>
            <Modal isCentered isOpen={openModal} onClose={() => closeModal(false)}>
                ...
                <ModalContent width="95vw" borderRadius="6px" paddingBottom="20px" bgColor={bgColor} minHeight="40vh">
                    ...
                    <Box bgColor={secondarybgColor} textAlign="center" color="#319EF6" padding="25px 0" fontWeight="normal">
                    ...
                    <Flex justifyContent="space-between" alignContent="center" flexDirection="column" alignItems="center" py="4">
                        ...
                        <Button variant="brand" padding="24px 0" width="80%" isFullWidth boxShadow="none" border="0" mt={3} background={brandButtonColor} color="#FFFFFF" cursor="pointer" onClick={startTour1}>
                            Take this short tour
                        </Button>


                        <button onClick={() => closeModal(false)}>
                            <Text py={3} decoration='underline' fontSize="16px" fontWeight="normal" color={buttonColor}>
                                Skip tour</Text>
                        </button>
