...
export default function BridgeV2({ token1, token2, setToken1, setToken2, chainState, setChainState }) {
    ...
    const [token1Allowance, setToken1Allowance] = React.useState(0);
    const [token2Allowance, setToken2Allowance] = React.useState(0);
    ...
    const [lockAmountMax, setBridgeAmountMax] = React.useState(false);
    ...
    return (<>
        ...
        <Cwallet isOpenDialog = { isOpenDialog } setIsOpenDialog = { setIsOpenDialog } chain = { chainState } setChain = { setChainState } tokenDialogState = { tokenDialogState } setTokenDialogState = { setTokenDialogState } selectToken = { selectToken } /> 
    </>
    );
}