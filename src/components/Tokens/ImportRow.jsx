...
import { useColorModeValue, Box, Flex, Text, Button } from "@chakra-ui/react";
import { useIsTokenActive, useIsUserAddedToken } from "../../hooks/Tokens";
import { useDispatch } from "react-redux";
import { addImportedToken } from "../../state/lists/actions";
const ImportRow = ({ token, openNewTokenModal }) => {
    ...
    return (<>
        <Flex justifyContent="space-between" py="2" fontSize="16px" bg={boxColor} opacity='1' px="4" borderRadius="10px" m={2}>
            <Flex>
