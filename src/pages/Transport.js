...
const Bridge = (props) => {
    ...
    const TransportClasses = useStyles.Transport();
    ...
    handle_Date = (value) => {
        ...
        console.log("DATETIME (Transport): ", value, currentDate, value > currentDate)
            ...
            <Box className={classes.info}>
                <Grid container direction="row" justifyContent="space-evenly" alignItems="center" >
                    ...
                    <Grid className={isMobile ? `${mobileClasses.root} grid`  : "grid"} style={{marginTop:40}} item xs={12} sm={12} md={6} >
                        <Card className="card">
                            <CardHeader
                                className={TransportClasses.cardHeader}
                            ...
                            <CardContent >
                                ...
                                >
                                                    ...
                                                    <Grid item  xs={10} sm={11} md={11}>
                                                        ...
                                                        >
                                                            <Grid item className="text-center" xs={3} sm={2} md={2}>
                                                                <img className={TransportClasses.networkImage} src={item.url} alt="network" />
                                                            </Grid>
                                                            <Grid item   xs={9} sm={10} md={10}>
                                                                <p  color="textSecondary" className={TransportClasses.networkTitle}>
                                                                    {ui_friendly_networks[item.name]}
                                                                </p>
                                                                <p color="textSecondary" className={TransportClasses.networkDes}>
                                                                    {item.subtitle}
                                                                </p>
                                                            </Grid>
                                                        </Grid>
                                        ...
                                        <div key={2} style={{paddingLeft:1, paddingRight:1}}>
                                            ...
                                            >
                                                <Grid item  xs={10} sm={11} md={11}>
                                                    ...
                                                    >
                                                        <Grid item className="text-center" xs={3} sm={2} md={2}>
                                                            <img className={TransportClasses.networkImage} src={each.url} alt="network" />
                                                        </Grid>
                                                        <Grid item   xs={9} sm={10} md={10}>
                                                            <p  color="textSecondary" className={TransportClasses.networkTitle}>
                                                                {each.name}
                                                ...
                                                <Grid item  className="text-center" xs={2} sm={1} md={1}>
                                                    {each.name==subMethod ? <div className={TransportClasses.fillCircle} />: <div className={TransportClasses.emptyCircle} />}
                                                </Grid>
                                            </Grid>)
                                            }
                                        </div>
                                    ...
                                    <MobileStepper
                                        className={TransportClasses.mobileStepper}
                                        steps={maxSteps}
                                        position="static"
