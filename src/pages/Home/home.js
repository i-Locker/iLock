...
import Icon2 from '../../assets/img/common/Icon2.svg';
                            ...
                            <Grid container xs={12} lg={5} justifyContent="center">
                                {matches510 ?
                                    <Box sx={{ width: "100%", maxWidth: "450px" }}>
                                        ...
                                        <Typography component="img" src={Icon2} sx={{ height:150, position: "absolute", m: "190px 0 0 149.8px" }}></Typography>
                ...
                <Container>
                    <Stack sx={{ p: "96px 0 129px" }} direction="column">
                        <Grid sx={{ p: "38px 0" }} container justifyContent="center">
                            <Typography variant='h4' align='center'>Ecosystem</Typography>
                        </Grid>
