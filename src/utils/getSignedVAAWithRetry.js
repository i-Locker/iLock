import { getGovernorIsVAAEnqueued, getSignedVAA, } from "@certusone/wormhole-sdk";
import { WORMHOLE_RPC_HOSTS } from "./consts";
export const getSignedVAAWithRetry = async (emitterChain, emitterAddress, sequence, retryAttempts) => {
