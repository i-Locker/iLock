...
import { ChainGrpcBankApi, ChainGrpcWasmApi, TxGrpcClient, } from "@injectivelabs/sdk-ts";
...
export const getInjectiveWasmClient = () => new ChainGrpcWasmApi(INJECTIVE_NETWORK_INFO.grpc);
export const getInjectiveBankClient = () => new ChainGrpcBankApi(INJECTIVE_NETWORK_INFO.grpc);
export const getInjectiveTxClient = () => new TxGrpcClient(INJECTIVE_NETWORK_INFO.grpc);
export const isValidInjectiveAddress = (address) => {
...
export const formatNativeDenom = (denom) => denom === INJECTIVE_NATIVE_DENOM ? "INJ" : "";
export const broadcastInjectiveTx = async (walletStrategy, walletAddress, msgs, memo = "") => {
