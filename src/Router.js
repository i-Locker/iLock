            ...
            <Suspense fallback={<Spinner />}>
                <Switch>
                    ...
                    <BaseLayout>
                        ...
                        <Route path="/Claim" exact component={Claim} />
                        <Route path="/my-lockers" exact component={iLocks} />
                        <Route path="/lockers" exact component={iLocks} />
                        <Route path="/lockup/:chainName" exact component={LockUp} />
                        <Route path="/lockers/:chainName" exact component={LockUp} />
