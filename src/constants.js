...
export const iBridgeBaseFee = {
    "Ethereum": (0.005)*10**18,
    "Cronos": (0.005)*10**18,
    "Cronos_testnet": (0.005)*10**18,
    "Goerli": (0.005)*10**18,
    "Binance": (0.005)*10**18,
    "Binance_testnet": (0.005)*10**18,
    "Avalanche": (0.005)*10**18,
    "Avalanche_testnet": (0.005)*10**18,	
    "Frenchain_testnet": (0.005)*10**18,
    "Frenchain": (0.005)*10**18,
    "Polygon_testnet": (0.005)*10**18,
    "Polygon": (0.005)*10**18,
    "Kekchain": 0(0.005)*10**18,
    "Kekchain_testnet": 0(0.005)*10**18
};
...
export const tokens_data = {
   ...
   "Cronos_testnet" : { name: "Cronos_testnet", currency: "tCRO", subtitle: `Choose if the proejct is deployed to Cronos (testnet)`, url: "/networks/cronos.svg", chainData: { chainId: '0x152', chainName: "Cronos Testnet", rpcUrls: ["https://evm-t3.cronos.org"], blockExplorerUrls: ['https://testnet.cronoscan.com/'], nativeCurrency: { name: "Cronos", symbol: 'tCRO', decimals: 18 }, tokens: [{ name: "Cronos", symbol: "wCRO", decimals: 18 , contract: "0x2A0Ff2dB23a65bb9E9313f8670b9C2bB5Ed13771" }] } },
   ...
   "Polygon_testnet" : { name: "Polygon_testnet", currency: "tMATIC", subtitle: `Choose if the proejct is deployed to Polygon (testnet)`, url: "/networks/matic.svg", chainData: { chainId: '0x13881', chainName: "Polygon Testnet", rpcUrls: ["https://rpc-mumbai.maticvigil.com"], blockExplorerUrls: ['https://mumbai.polygonscan.com/'], nativeCurrency: { name: "Polygon", symbol: 'tMATIC', decimals: 18 }, tokens: [{ name: "Polygon", symbol: "tMATIC", decimals: 18 , contract: "0x9c3c9283d3e44854697cd22d3faa240cfb032889" }] }  },
